            ...
            <body>
                <div>
                  <div class="actions--bar">
                    <div class="bounds">
                      <div class="grid-100"><span><Link class="button" to="/courses/updatecourse">Update Course</Link>
                      <Link class="button" to="/courses/deletecourse">Delete Course</Link></span>
                      <Link class="button button-secondary" to="/courses/">Return to List</Link></div>
                    </div>
                  </div>
